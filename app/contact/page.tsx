      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <aside className="border border-edge-line bg-white/[0.02] p-6">
            <h2 className="text-2xl font-semibold text-white">EDGE03 LLC</h2>
            <p className="mt-4 text-base leading-7 text-edge-soft">
              Placeholder contact email:
            </p>
            <a
              className="mt-2 inline-flex text-edge-soft transition-colors hover:text-white"
          ...
          <form className="grid gap-4 border border-edge-line bg-edge-matte p-6">
            <label className="grid gap-2 text-sm text-edge-soft">
              Name
              <input
                className="min-h-12 border border-edge-line bg-edge-black px-4 text-white outline-none transition-colors focus:border-white"
                name="name"
            ...
            <label className="grid gap-2 text-sm text-edge-soft">
              Project Notes
              <textarea
                className="min-h-36 resize-y border border-edge-line bg-edge-black px-4 py-3 text-white outline-none transition-colors focus:border-white"
                name="message"
